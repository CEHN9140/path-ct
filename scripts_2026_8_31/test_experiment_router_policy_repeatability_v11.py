...
def test_v11_router_calibration_reuses_one_canonical_payload_for_all_replays(tmp_path, monkeypatch):
    ...
    class Router:
        ...
        def invoke(self, payload):
            ...
            return {"actions": [{"action": "accept", "target_ids": ["C1"], "decision_state": {"identity": "unassessed", "structure": "unassessed", "alternative_explanation": "unassessed", "uncertainty": "yes"}, "reason": "consistent"}]}
...
def test_v11_calibration_marks_mutated_replay_payload_invalid(tmp_path, monkeypatch):
    ...
    class MutatingRouter:
        def invoke(self, payload):
            ...
            return {"actions": [{"action": "accept", "target_ids": ["C1"], "decision_state": {"identity": "unassessed", "structure": "unassessed", "alternative_explanation": "unassessed", "uncertainty": "yes"}, "reason": "ok"}]}
