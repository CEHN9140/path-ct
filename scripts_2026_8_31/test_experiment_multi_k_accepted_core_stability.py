...
from scripts_2026_8_31 import experiment_multi_k_accepted_core_stability as experiment
...
def test_analyze_excludes_incomplete_and_unavailable_runs(tmp_path):
    ...
    assert summary["missing_run_count"] == 18
...
def test_single_repeat_analysis_is_exploratory_only(tmp_path):
    ...
    assert summary["valid_run_count"] == 1
    assert summary["analysis_status"] == "primary_unavailable"
    assert summary["missing_run_count"] == 20
