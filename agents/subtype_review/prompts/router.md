...
Do not request all available pair boundaries by default. Request only pairs whose unresolved boundary could materially change a retention or structural-revision decision; availability alone is not a reason for pair review.
