...
METRIC_SEMANTICS = {
    ...
    ("biological_support", "wxs_mutation_enrichment"): {
        ...
        "odds_ratio": "Target-versus-rest mutation enrichment or depletion effect; values above one indicate enrichment in the target.",
        "odds_ratio_ci95": "95% log-odds interval using the same Haldane-Anscombe corrected estimator as the odds ratio when a table cell is zero.",
        "zero_cell_correction_applied": "A 0.5 Haldane-Anscombe correction was used for the odds ratio and interval; Fisher p-value still uses the original uncorrected table.",
